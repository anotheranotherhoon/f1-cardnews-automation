...
목요일 프리뷰부터 월요일 총정리까지 주 5회, 사람이 하는 일은 텔레그램으로 도착한 카드를 보고 발행 버튼을 누르는 것뿐이다. 마음에 안 드는 카드가 있으면 채팅으로 말하면 해당 카드만 다시 만든다. 잘못 발행했다면 발행 완료 알림의 버튼으로 처음부터 다시 만들 수 있다.
...
flowchart TD
    ...
    W7["WF-7 · 텔레그램 리스너"] -.->|"채팅 답장을 받아<br/>대기 중인 실행을 재개"| Q
